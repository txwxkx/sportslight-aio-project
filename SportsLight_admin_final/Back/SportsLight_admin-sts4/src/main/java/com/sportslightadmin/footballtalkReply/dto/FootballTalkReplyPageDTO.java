...
@NoArgsConstructor
@Component("FootballTalkReplyPageDTO")
public class FootballTalkReplyPageDTO {
	...
	public FootballTalkReplyPageDTO(int currentPage, int totalCount) {
	...
	public FootballTalkReplyPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
