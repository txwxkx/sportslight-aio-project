...
@Component("FootballTalkPageDTO")
public class FootballTalkPageDTO {
	...
	public FootballTalkPageDTO() {

	}

	public FootballTalkPageDTO(int currentPage, int totalCount) {
	...
	public FootballTalkPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
