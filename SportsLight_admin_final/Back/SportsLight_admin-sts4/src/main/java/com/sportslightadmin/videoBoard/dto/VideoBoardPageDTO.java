...
public class VideoBoardPageDTO {
	...
	public void setVideoBoardDTO(VideoBoardDTO videoBoardDTO) {
		...
		this.videoNum = videoBoardDTO.getVideoNum();
	}

	public VideoBoardPageDTO(int currentPage, int totalCount) {
	...
	public VideoBoardPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
