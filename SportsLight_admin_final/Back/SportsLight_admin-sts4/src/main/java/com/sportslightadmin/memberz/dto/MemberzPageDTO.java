...
@Component("memberzPageDTO")
public class MemberzPageDTO {
	...
	public MemberzPageDTO() {

	}

	public MemberzPageDTO(int currentPage, int totalCount) {
	...
	public MemberzPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
