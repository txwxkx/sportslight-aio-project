...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
	private MemberzDAO userRepository;

	public JwtAuthorizationFilter(AuthenticationManager authManager, MemberzDAO userRepository) {
		super(authManager);
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (username != null) {
			...
			// 넣어준다.
			MemberzDTO user = userRepository.selectByEmail(username);
